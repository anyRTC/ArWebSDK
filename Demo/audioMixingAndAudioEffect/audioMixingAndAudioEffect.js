...
async function startAudioMixing(file) {
  ...
  try {
    ...
    localTracks.audioMixingTrack = await ArRTC.createBufferSourceAudioTrack(options);
...
async function playEffect(cycle, options) {
  ...
  localTracks.audioEffectTrack = await ArRTC.createBufferSourceAudioTrack(options);
